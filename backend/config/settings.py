...
SECRET_KEY = 'django-insecure---s2!w-k5r=coh+uh9u97%3=rmy8o+s#58h1x!gr&j897q4yxp'
...
STATIC_URL = 'static/'
# React frontend allowed origins
...
MQTT_ACK_TOPIC = f"{MQTT_TOPIC_PREFIX}/server/ack"